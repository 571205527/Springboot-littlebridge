...
public class SessionManager extends DefaultWebSessionManager {
    ...
    /**
     * 获取sessionId从请求中
     * 我们通常是在请求头中增加一个请求头Authorization，它的值是一串加密的信息或者密钥，在后台通过对这个请求头值的读取，获取用户的信息。
     * @param request
     * @param response
     * @return
     */
    ...
    //调用了三个父类的私有方法，getSessionIdCookieValue、getUriPathSegmentParamValue、getSessionIdName，
    // 也就是我使用copy super标注的部分，这部分是我复制父类的方法，让在不使用ajax的情况下能够正常使用cookie+session模式
    // copy super(private method)
