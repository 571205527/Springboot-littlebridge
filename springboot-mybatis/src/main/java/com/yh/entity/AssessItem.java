...
public class AssessItem implements Serializable {
    ...
    public Byte getItemScore() {
        return itemScore;
    }

    public void setItemScore(Byte itemScore) {
    ...
    public boolean equals(Object that) {
        ...
        AssessItem other = (AssessItem) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getItemIcon() == null ? other.getItemIcon() == null : this.getItemIcon().equals(other.getItemIcon()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getItemIcon() == null) ? 0 : getItemIcon().hashCode());
